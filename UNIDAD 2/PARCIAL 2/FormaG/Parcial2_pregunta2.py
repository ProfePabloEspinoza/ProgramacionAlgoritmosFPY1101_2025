...
# Generar el número aleatorio en el rango completo
num = randint(n1, n2) // 4  # El número generado se divide por 4

# Primer intento
i1 = int(input('Intente adivinar: '))
if i1 == num:
    print('Felicitaciones, pudiste adivinar en el primer intento.')
else:
